...
class ModelHiddenParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.no_do=True # cancel the deformation of Gaussians' density
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.density_threshold_coarse = 0.005
        self.density_threshold_fine_init = 0.005
        self.density_threshold_fine_after = 0.005
